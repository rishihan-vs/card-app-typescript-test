    ...
    <div>
      <nav className="flex justify-center gap-5">
        ...
        <button
          ...
          className="m-3 p-4 text-xl bg-gray-500 hover:bg-gray-600 rounded-md font-medium text-white"
        >
          Settings
        </button>
      </nav>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-lg max-w-sm w-full">
            ...
            <label className="flex items-center">
              <input type="checkbox" checked={isDarkMode} onChange={toggleDarkMode} className="mr-2" />
